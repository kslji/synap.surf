...
#   - Fear & Greed Index
#   - RSS news headline sentiment (Claude-analyzed)
#   - Technical chart analysis (reusing existing strategy lib)
# All trades are paper-traded via detailed logs for now.
